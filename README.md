...
This is the code repository for the paper "MultiReflect: Multimodal Self-Reflective RAG-based Automated Fact-Checking". **This branch is for running the pipeline with DeepSeek models i.e. DeepSeek-VL2**
...
| Setting                           | Description                                                                 |
|-----------------------------------|-----------------------------------------------------------------------------|
| `model_id`                        | DeepSeek multimodal reasoning model from Huggingface (e.g., `'deepseek-ai/deepseek-vl2-tiny'`)                          |
